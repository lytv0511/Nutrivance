...
enum NutrivanceCatalystMenuBuilder {
    ...
    private static let postSelector = #selector(UIApplication.nutrivanceCatalystPostNotification(_:))
    ...
    private static func vcKey(_ title: String, _ name: Notification.Name, input: String, _ modifiers: UIKeyModifierFlags) -> UIKeyCommand {
        UIKeyCommand(title: title, action: postSelector, input: input, modifierFlags: modifiers, propertyList: name.rawValue)
    }
    ...
    static func augmentMainMenu(with builder: UIMenuBuilder) {
        let navigation = UIMenu(
            ...
            children: [
                ...
                navKey("Pathfinder", input: "f", cmdShift, plist: "pathfinder"),
