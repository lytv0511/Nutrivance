...
public struct WorkoutActivityState: Codable, Hashable {
    ...
    var formattedDistance: String {
        ...
        return String(format: "%.1f km", totalDistanceKilometers)
    }
...
public struct WorkoutLiveActivityAttributes: Codable, Hashable {
