//
//  WorkoutLiveActivityShared.swift
//  WaterWidget
//
//  Attributes and state for Workout Live Activity - widget extension copy
//  This must be identical to Nutrivance/WorkoutLiveActivityAttributes.swift
//
